...
const schema = z.object({
  ...
  RUN_EVENTS_SIGNATURE_REQUIRED: booleanFromEnv.default(true),
  RUN_EVENTS_SIGNATURE_MAX_AGE_SECONDS: z.coerce.number().int().positive().default(300),
  TRUST_PROXY_ENABLED: booleanFromEnv.default(false),
...
export const config: ApiConfig = loadEnv(schema, {
  ...
  RUN_EVENTS_SIGNATURE_REQUIRED: true,
  RUN_EVENTS_SIGNATURE_MAX_AGE_SECONDS: 300,
